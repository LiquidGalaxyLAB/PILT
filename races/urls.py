...
urlpatterns = [
    ...
    url(r'^ground_races/race/(?P<pk>[0-9]+)/$', views.detail_race, name='detail_race'),
    url(r'^air_races/race/(?P<pk>[0-9]+)/$', views.detail_race, name='detail_race'),
    ...
    url(r'^ground_races/race/$/send/(?P<participant>\w+)/$', views.ground_race_send, name='ground_race_send'),
